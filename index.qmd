...
::: {.news-list}
::: {.news-item}
**May 2026**  `Dataset` `RFFI` `Wi-Fi`  
New datasets released on the [Resources](resources/index.qmd) page: Wi-Fi RFFI Signal-Level Synthetic Traces and Protocol-Level Emulated Traces, supporting impersonation detection research.
:::
